...
> Answer: Is when Javascript within a client app manage the data within it's own memory.
- [x] What does AJAX stand for?
> Answer: Asynchronous JavaScript And XML
- [x] What are `controlled components` in React?
> Answer:is one that takes its current value through props and notifies changes through callbacks like onChange
